var v=Object.defineProperty,u=Object.getOwnPropertyDescriptor,o=(e,s,t,i)=>{for(var l=i>1?void 0:i?u(s,t):s,r=e.length-1,a;r>=0;r--)(a=e[r])&&(l=(i?a(s,t,l):a(l))||l);return i&&l&&v(s,t,l),l};import{LitElement as h,html as n,css as m,property as c,customElement as d}from"../web_modules/lit-element.js";import{repeat as p}from"../web_modules/lit-html/directives/repeat.js";import{classMap as b}from"../web_modules/lit-html/directives/class-map.js";import"../web_modules/@material/mwc-checkbox.js";import"../web_modules/@material/mwc-icon-button.js";import"./dismissable-item.js";import{style as g}from"./mwc-list-item-css.js";import{JSONStore as w}from"./grocery-store.js";export let GroceryItem=class extends h{constructor(){super(...arguments);this.label="",this.sublabel="",this.checked=!1}handleCheckboxChange(e){this.dispatchEvent(new CustomEvent("change",{detail:{checked:e.target.checked}}))}handleItemDismissal(){this.dispatchEvent(new Event("remove"))}render(){return n`
      <div>
    ...
    `],o([c()],GroceryItem.prototype,"label",2),o([c()],GroceryItem.prototype,"sublabel",2),o([c({type:Boolean})],GroceryItem.prototype,"checked",2),GroceryItem=o([d("grocery-item")],GroceryItem);export let GroceriesList=class extends h{constructor(){super();this.#e=new w,this.#t=[],this.#s=[];const e=async()=>{this.#s=[],this.#t=[];for await(let[s,t]of this.#e.entries())t.name=s,t.done?this.#s.push(t):this.#t.push(t);await this.requestUpdate()};this.#e.addEventListener("change",e),e()}#e;#t;#s;async _onchange(e){e.stopPropagation();const s=e.target.label,t=e.detail.checked,i=await this.#e.get(s);i.done=t,this.#e.set(s,i)}_onremove(e){this.#e.remove(e.target.label)}_isAllDone(){return!this.#t.length}_hasDoneItems(){return!!this.#s.length}render(){return n`

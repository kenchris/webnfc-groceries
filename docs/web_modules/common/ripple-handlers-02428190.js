import{_ as i}from"./foundation-dde8a859.js";import{d as m,A as u,P as f,h as g}from"./lit-html-e7095b40.js";import{L as y,c as v}from"./lit-element-f25bd23a.js";import{query as b,property as o,internalProperty as s,customElement as w}from"../lit-element/lib/decorators.js";import{M as S}from"./foundation-c4780e20.js";import{classMap as A}from"../lit-html/directives/class-map.js";/**
@license
...
*/const l=()=>{},I={get passive(){return!1}};document.addEventListener("x",l,I),document.removeEventListener("x",l);/**
@license
Copyright 2018 Google Inc. All Rights Reserved.
...
See the License for the specific language governing permissions and
limitations under the License.
*/class R extends y{click(){if(this.mdcRoot){this.mdcRoot.focus(),this.mdcRoot.click();return}super.click()}createFoundation(){this.mdcFoundation!==void 0&&this.mdcFoundation.destroy(),this.mdcFoundationClass&&(this.mdcFoundation=new this.mdcFoundationClass(this.createAdapter()),this.mdcFoundation.init())}firstUpdated(){this.createFoundation()}}/**
 * @license
 ...
 */const h=new WeakMap,L=m(t=>e=>{if(!(e instanceof u)||e instanceof f||e.committer.name!=="style"||e.committer.parts.length>1)throw new Error("The `styleMap` directive must be used in the style attribute and must be the only part in the attribute.");const{committer:p}=e,{style:c}=p.element;let d=h.get(e);d===void 0&&(c.cssText=p.strings.join(" "),h.set(e,d=new Set)),d.forEach(a=>{a in t||(d.delete(a),a.indexOf("-")===-1?c[a]=null:c.removeProperty(a))});for(const a in t)d.add(a),a.indexOf("-")===-1?c[a]=t[a]:c.setProperty(a,t[a])});class r extends R{constructor(){super(...arguments);this.primary=!1,this.accent=!1,this.unbounded=!1,this.disabled=!1,this.activated=!1,this.selected=!1,this.hovering=!1,this.bgFocused=!1,this.fgActivation=!1,this.fgDeactivation=!1,this.fgScale="",this.fgSize="",this.translateStart="",this.translateEnd="",this.leftPos="",this.topPos="",this.mdcFoundationClass=S}get isActive(){return(this.parentElement||this).matches(":active")}createAdapter(){return{browserSupportsCssVars:()=>!0,isUnbounded:()=>this.unbounded,isSurfaceActive:()=>this.isActive,isSurfaceDisabled:()=>this.disabled,addClass:t=>{switch(t){case"mdc-ripple-upgraded--background-focused":this.bgFocused=!0;break;case"mdc-ripple-upgraded--foreground-activation":this.fgActivation=!0;break;case"mdc-ripple-upgraded--foreground-deactivation":this.fgDeactivation=!0;break}},removeClass:t=>{switch(t){case"mdc-ripple-upgraded--background-focused":this.bgFocused=!1;break;case"mdc-ripple-upgraded--foreground-activation":this.fgActivation=!1;break;case"mdc-ripple-upgraded--foreground-deactivation":this.fgDeactivation=!1;break}},containsEventTarget:()=>!0,registerInteractionHandler:()=>{},deregisterInteractionHandler:()=>{},registerDocumentInteractionHandler:()=>{},deregisterDocumentInteractionHandler:()=>{},registerResizeHandler:()=>{},deregisterResizeHandler:()=>{},updateCssVariable:(t,e)=>{switch(t){case"--mdc-ripple-fg-scale":this.fgScale=e;break;case"--mdc-ripple-fg-size":this.fgSize=e;break;case"--mdc-ripple-fg-translate-end":this.translateEnd=e;break;case"--mdc-ripple-fg-translate-start":this.translateStart=e;break;case"--mdc-ripple-left":this.leftPos=e;break;case"--mdc-ripple-top":this.topPos=e;break}},computeBoundingRect:()=>(this.parentElement||this).getBoundingClientRect(),getWindowPageOffset:()=>({x:window.pageXOffset,y:window.pageYOffset})}}startPress(t){this.waitForFoundation(()=>{this.mdcFoundation.activate(t)})}endPress(){this.waitForFoundation(()=>{this.mdcFoundation.deactivate()})}startFocus(){this.waitForFoundation(()=>{this.mdcFoundation.handleFocus()})}endFocus(){this.waitForFoundation(()=>{this.mdcFoundation.handleBlur()})}startHover(){this.hovering=!0}endHover(){this.hovering=!1}waitForFoundation(t){this.mdcFoundation?t():this.updateComplete.then(t)}render(){const t={"mdc-ripple-upgraded--unbounded":this.unbounded,"mdc-ripple-upgraded--background-focused":this.bgFocused,"mdc-ripple-upgraded--foreground-activation":this.fgActivation,"mdc-ripple-upgraded--foreground-deactivation":this.fgDeactivation,hover:this.hovering,primary:this.primary,accent:this.accent,disabled:this.disabled,activated:this.activated,selected:this.selected};return g`
        <div class="mdc-ripple-surface mdc-ripple-upgraded ${A(t)}"
          style="${L({"--mdc-ripple-fg-scale":this.fgScale,"--mdc-ripple-fg-size":this.fgSize,"--mdc-ripple-fg-translate-end":this.translateEnd,"--mdc-ripple-fg-translate-start":this.translateStart,"--mdc-ripple-left":this.leftPos,"--mdc-ripple-top":this.topPos})}"></div>`}}i([b(".mdc-ripple-surface")],r.prototype,"mdcRoot",void 0),i([o({type:Boolean})],r.prototype,"primary",void 0),i([o({type:Boolean})],r.prototype,"accent",void 0),i([o({type:Boolean})],r.prototype,"unbounded",void 0),i([o({type:Boolean})],r.prototype,"disabled",void 0),i([o({type:Boolean})],r.prototype,"activated",void 0),i([o({type:Boolean})],r.prototype,"selected",void 0),i([s()],r.prototype,"hovering",void 0),i([s()],r.prototype,"bgFocused",void 0),i([s()],r.prototype,"fgActivation",void 0),i([s()],r.prototype,"fgDeactivation",void 0),i([s()],r.prototype,"fgScale",void 0),i([s()],r.prototype,"fgSize",void 0),i([s()],r.prototype,"translateStart",void 0),i([s()],r.prototype,"translateEnd",void 0),i([s()],r.prototype,"leftPos",void 0),i([s()],r.prototype,"topPos",void 0);/**
@license
Copyright 2018 Google Inc. All Rights Reserved.
...
See the License for the specific language governing permissions and
limitations under the License.
*/class F{constructor(t){this.startPress=e=>{t().then(p=>{p&&p.startPress(e)})},this.endPress=()=>{t().then(e=>{e&&e.endPress()})},this.startFocus=()=>{t().then(e=>{e&&e.startFocus()})},this.endFocus=()=>{t().then(e=>{e&&e.endFocus()})},this.startHover=()=>{t().then(e=>{e&&e.startHover()})},this.endHover=()=>{t().then(e=>{e&&e.endHover()})}}}export{F as R};

  ...
  pointer-events: none;
    ...
    `;return W`
      ${this.href?W`
        ...
        `}
    `}};Bi.styles=Fi,Mi([_t({type:Boolean})],Bi.prototype,"raised",void 0),Mi([_t({type:Boolean})],Bi.prototype,"unelevated",void 0),Mi([_t({type:Boolean})],Bi.prototype,"outlined",void 0),Mi([_t({type:Boolean})],Bi.prototype,"dense",void 0),Mi([_t({type:Boolean,reflect:!0})],Bi.prototype,"disabled",void 0),Mi([_t({type:Boolean})],Bi.prototype,"trailingIcon",void 0),Mi([_t()],Bi.prototype,"icon",void 0),Mi([_t()],Bi.prototype,"label",void 0),Mi([_t()],Bi.prototype,"href",void 0),Bi=Mi([ht("mwc-button")],Bi);const Vi=new WeakMap,ji=u(t=>e=>{if(!(e instanceof P)||e instanceof M||"style"!==e.committer.name||e.committer.parts.length>1)throw new Error("The `styleMap` directive must be used in the style attribute and must be the only part in the attribute.");const{committer:i}=e,{style:n}=i.element;Vi.has(e)||(n.cssText=i.strings.join(" "));const o=Vi.get(e);for(const e in o)e in t||(-1===e.indexOf("-")?n[e]=null:n.removeProperty(e));for(const e in t)-1===e.indexOf("-")?n[e]=t[e]:n.setProperty(e,t[e]);Vi.set(e,t)}),Ui=At`/**
@license
Copyright 2018 Google Inc. All Rights Reserved.

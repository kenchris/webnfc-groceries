...
export let DismissableItem = _decorate([customElement('dismissable-item')], function (_initialize, _LitElement) {
  class DismissableItem extends _LitElement {
    constructor() {
      super();
  ...
  return {
    ...
    `;
      ...
      kind: "method",
      key: "settle",
      value: function settle(targetPosition) {
        this.state = 'initial';
        ...
        const animation = this.wrapper.animate({
          transform: [`translateX(${this.position}px)`, `translateX(${targetPosition}px)`],
      ...
      kind: "method",
      key: "fling",
      value: function fling(velocityX) {
        this.state = 'initial';
      ...
      kind: "method",
      key: "_settleToClosestPosition",
      value: function _settleToClosestPosition() {
      ...
      kind: "method",
      key: "_onPointerDown",
      value: function _onPointerDown(change) {
        this.state = 'initial';
      ...
      kind: "method",
      key: "_onPointerPan",
      value: function _onPointerPan(change) {
        if (this.state == 'initial') {
          const deltaX = change.clientX - this.startX;
          const deltaY = change.clientY - this.startY; // Shaky or sloppy fingers are common using scroll, so
      ...
      kind: "method",
      key: "_onPointerUp",
      value: function _onPointerUp(change) {
        if (this.state == 'dragging') {
